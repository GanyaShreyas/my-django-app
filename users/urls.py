...
urlpatterns=[
 ...
 path('',views.index,name='index'),
  ...
  path('reset/done/',auth_view.PasswordResetCompleteView.as_view(template_name='users/password_complete_reset.html'),name='password_reset_complete'),
...
"""
path("logout/", 
  auth_view.LogoutView.as_view(http_method_names=["post", "get", "options"],
